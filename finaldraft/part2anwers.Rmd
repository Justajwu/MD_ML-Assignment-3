...
We decided to use found.contraband as the first classifier.
For this, we first subsetted the full sqf data to only include 
 criminal possession or sale of 'marihuana' 
 and 'controlled substance' as suspected reasons.
We want to build a model to predict when in the situations when 

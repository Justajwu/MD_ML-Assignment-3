...
arrest.offenses.path <- '/home/codas/Documents/Ravi/homework/MD_ML-Assignment-3/arrest.offenses.tsv'
offense.codes.path <- '/home/codas/Documents/Ravi/homework/MD_ML-Assignment-3/offense-codes.tsv'
...
offense.codes <- read.delim(offense.codes.path, header=FALSE, col.names=c('code','offense'))
...
arrest.offenses <- read.delim(arrest.offenses.path, header=FALSE, col.names=c('real.offense','nominal.offense'))

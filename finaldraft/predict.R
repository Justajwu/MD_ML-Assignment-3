...
# 2. Why is the probability of being caught with a wapon in 2AII so high for both genders? Is that right?
# 3. Answer 2B is not running.. See Rmd file.
# 4. Lauren's part 2C has a small bug where two vectors are not the same length.
# 5. Fix descriptions...
